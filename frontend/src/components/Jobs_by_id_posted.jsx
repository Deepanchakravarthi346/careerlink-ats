...
const Jobs_by_id_posted = () => {
  ...
  useEffect(() => {
    fetch(`${API_BASE}/accounts/jobsbyid/${id}/`, {
      method: "GET",
      headers: {
      ...
      <div className="job-content-wrapper">
        ...
        <div className="job-sidebar">
          <Card className="sidebar-card">
            ...
            >
              <FaUsers style={{ marginRight: '8px' }} /> View Applicants
            </Button>
            ...
            >
              <FaEdit style={{ marginRight: '8px' }} /> Edit Job
            </Button>
          </Card>
        </div>
      </div>
...
export default Jobs_by_id_posted;
