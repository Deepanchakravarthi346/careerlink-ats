...
const Db_total_reject = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
    fetch(`${API_BASE}/accounts/dashboardreject/`, {
      method: "GET",
      headers: {
    ...
    <div className="applicants-container">
      <div className="applicants-header">
        <div>
          ...
          <p>Review candidates that have been rejected.</p>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <EmptyState 
          ...
          description="You haven't rejected any candidates yet."
        />
      ) : (
        <div className="applicants-grid">
          {applicants.map((item) => (
...
export default Db_total_reject;
